...
<main style="background-color: rgb(167, 164, 164);" >
		...
		<div class="container">
			...
			<?php 
				...
				if (($_POST["email"] == $user) and ($_POST["password"] == $pass))
				{
			       ...
			       echo("Giriş Yapma İşlemi Başarılı.");
				   echo("İstediğiniz başka bir sayfaya geçiş yapabilirsiniz.");
				   echo("10 saniye içinde Anasayfaya yönlendirileceksiniz.");
				   header("Refresh: 10; url=anasayfa.html");
			
				}
			
				else 
				{
			            echo "Girdiğiniz kullanıcı adı veya şifre hatalı!<br>";
    ...
    <footer class="bg-dark " style="height: 40px; color: white; text-align: center; ">2021 Bahar dönemi @Ömer Faruk Sunar g201210075</footer>
</main>
